$(document).ready(function(){
        var images = [
           ["linear-gradient(rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.1)), url(images/Ann_and_Chris_Short_Eared_Owl.jpg) no-repeat center", "<a href='#'>USS John F. Kennedy<br> by Claire Gentile</a>"],
           ["linear-gradient(rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.1)), url(images/Audrey_Bellot_Kiss_the_paws.jpg) no-repeat center", "<a href='#'>K I S S • T H E • P A W S <br> by Audrey Bellot</a>"],
        ...
        $(".background-pic").css("background-size","cover");
